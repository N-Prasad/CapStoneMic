...
public class LineItem {
	...
	public String toString() {
		return "LineItem [lineItemId=" + Objects.toString(lineItemId, "null") + ", productId="
				+ Objects.toString(productId, "null") + ", productName=" + Objects.toString(productName, "null")
				+ ", quantity=" + Objects.toString(quantity, "null") + ", price=" + Objects.toString(price, "null")
				+ "]";
	}
